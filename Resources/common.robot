...
Open Browser to  [Arguments]  ${location}
  Run Keyword If      'HeadlessChrome' == 'HeadlessChrome'      Open Headless Chrome Browser to    ${location}
  ...     ELSE IF     'HeadlessChrome' == 'HeadlessFirefox'     Open Headless Firefox Browser to    ${location}
...
Open Graphical Browser to  [Arguments]  ${location}
  Open Browser    ${location}    HeadlessChrome
